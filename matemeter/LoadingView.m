...
//
+ (id)loadingViewInView:(UIView *)aSuperview withMsg:(NSString*)msg
{
	...
	CGRect labelFrame = CGRectMake(0, 110, DEFAULT_LABEL_WIDTH, DEFAULT_LABEL_HEIGHT);
	...
	labelFrame.origin.y = 105; //floor(0.5 * (loadingView.frame.size.height - totalHeight));
